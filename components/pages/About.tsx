    ...
    <div className="min-h-screen ">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <Badge className="mb-4 bg-pink-100 text-pink-600">Notre Mission</Badge>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                <div className="text-4xl text-pink-600 mb-2">2000+</div>
                <div className="text-sm text-gray-600">Clientes heureuses</div>
              </div>
              <div className="text-center">
                <div className="text-4xl text-pink-600 mb-2">4.9</div>
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-purple-100 text-purple-600">Nos Valeurs</Badge>
            <h2 className="text-4xl text-gray-900 mb-6">
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-amber-100 text-amber-600">Notre Équipe</Badge>
            <h2 className="text-4xl text-gray-900 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <Card key={index} className="bg-white border-0 shadow-xl rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm text-gray-600">{member.experience} d'expérience</span>
                  </div>
                  <div className="space-y-2">
                    <p className="text-xs text-gray-500 mb-2">Spécialités :</p>
                    {member.specialties.map((specialty, i) => (
                      <Badge key={i} variant="outline" className="mr-2 text-xs">
                        {specialty}
                      </Badge>
                    ))}
                  </div>
        ...
        <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-3xl p-12 mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card className="bg-white border-0 shadow-lg p-6 rounded-2xl text-center">
                <div className="text-4xl text-pink-500 mb-2">100%</div>
                <p className="text-gray-700">Produits premium</p>
              </Card>
              <Card className="bg-white border-0 shadow-lg p-6 rounded-2xl text-center">
                <div className="text-4xl text-purple-500 mb-2">247</div>
                <p className="text-gray-700">Avis 5 étoiles</p>
              </Card>
              <Card className="bg-white border-0 shadow-lg p-6 rounded-2xl text-center">
                <div className="text-4xl text-amber-500 mb-2">98%</div>
                <p className="text-gray-700">Clientes fidèles</p>
              </Card>
              <Card className="bg-white border-0 shadow-lg p-6 rounded-2xl text-center">
                <div className="text-4xl text-green-500 mb-2">24/7</div>
                <p className="text-gray-700">Support client</p>
              </Card>
            </div>
          </div>
        </div>
