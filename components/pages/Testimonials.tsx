          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-4 mb-4">
                <div className="text-7xl text-gray-900">{stats.averageRating}</div>
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
              ...
              <p className="text-2xl text-gray-700 mb-2">Note moyenne</p>
              <p className="text-gray-600">Basée sur {stats.totalReviews} avis vérifiés</p>
              <a
