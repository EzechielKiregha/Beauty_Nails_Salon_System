...
export async function PATCH(
  ...
  try {
    ...
    if (transfer.newWorkerId !== workerProfile.id) {
      return errorResponse('Vous ne pouvez répondre qu\'à vos propres demandes de transfert', 403);
    }
    ...
    if (action === 'accept') {
      ...
      return errorResponse('Action invalide. Utilisez "accept" ou "reject"', 400);
    }
